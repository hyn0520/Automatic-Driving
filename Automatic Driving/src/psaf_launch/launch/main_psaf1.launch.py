...
__psaf_lane_detection_outside = IncludeLaunchDescription(PythonLaunchDescriptionSource(
    os.path.join(get_package_share_directory('psaf_lane_detection_outside'),
                 'launch', 'lane_detection_outside.launch.py')
))
